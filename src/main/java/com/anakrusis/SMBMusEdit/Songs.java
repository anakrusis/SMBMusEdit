...
public class Songs {
    ...
    public static Song UNDERWATER = new Song ("Underwater");
    public static Song UNDERGROUND = new Song ("Underground");
    public static Song CASTLE = new Song ("Castle");
    public static Song CLOUD = new Song ("Cloud");
    public static Song PRE_PIPE = new Song ("Pre-Pipe Theme");
    public static Song STARMAN = new Song ("Starman Theme");
    public static Song WORLD_TITLE = new Song ("World Title");

    public static void init(){
        for (int i = 0; i < 34; i++){
            Song OVERWORLD = new Song("Overworld " + (i + 1));
        }
    }
}
